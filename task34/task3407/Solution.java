...
public class Solution {
    ...
    public static class Helper {
        ...
        public List<PhantomReference<Monkey>> getPopulatedList() {
            List<PhantomReference<Monkey>> referenceList = new ArrayList<PhantomReference<Monkey>>();
            for ( int i = 1; i <= 200; i++)
            {

                referenceList.add(new PhantomReference<Monkey>(new Monkey(),helper.getQueue()));
            }
